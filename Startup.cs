            ...
            var supportedCultures = new[]
{
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
                ...
                routes.MapRoute(name: "search", template: "Search/{name?}", defaults: new { controller = "Search", action = "ArtistSearch" });
                ...
                routes.MapRoute(name: "taskLists", template: "TaskLists/{id?}/{completed?}", defaults: new { controller = "TaskList", action = "TaskListsCollection" });
                ...
                routes.MapRoute(name: "addTask", template: "AddTask/{id?}/{name?}", defaults: new { controller = "TaskList", action = "AddTask" });
                routes.MapRoute(name: "addTask", template: "AddTask/{id?}/{name?}", defaults: new { controller = "TaskList", action = "AddTask" });
